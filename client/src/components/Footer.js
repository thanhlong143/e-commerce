...
const Footer = () => {
   return (
      <div className="w-full">
         <div className="w-full flex items-center justify-center h-[103px] bg-main">
            <div className="w-main flex items-center justify-between">
               ...
               <div className="flex-1 flex items-center">
                  <input
                     className="w-full p-4 pr-0 rounded-l-full flex-1 bg-[#F04646] outline-none text-gray-100 placeholder:text-sm placeholder:text-gray-200 placeholder:italic placeholder:opacity-50"
                     type="text" placeholder="Email address" name="" id=""
                  />
         ...
         <div className="w-full flex items-center justify-center h-[407px] bg-gray-900 text-white text-[13px]">
